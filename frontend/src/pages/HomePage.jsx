...
const FEATURES = [
  ...
  },
  {
    ...
    description:
      'Notifica automatica alla chiusura della lista con il riepilogo di presenze e regali prenotati. Promemoria il giorno dopo la festa per ricordare di ringraziare gli invitati.',
  },
  {
    icon: Star,
    emoji: null,
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-avorio via-avorio to-cipria/20 pt-10 pb-14 px-4">
        ...
        <div className="relative max-w-3xl mx-auto text-center">
          ...
          <p className="text-base text-gray-600 leading-relaxed max-w-2xl mx-auto mb-10">
            ...
            Con <span className="text-salvia font-semibold">Piky</span> organizza la festa, condividi il link e gli invitati confermano la presenza e prenotano i regali. Senza sovrapposizioni, senza caos.
          </p>
